...
\begin{tabular}{rl}
  ...
  & {\bf Software Engineer. Holland \& Hart LLP. Sep 2020 -- Mar 2020.} \\
  & \parbox{4.5in}{Developed legal work automation products using Haskell, JavaScript (Vue), and Microsoft Azure cloud.} \\ \\
...
\begin{tabular}{rl}
  ...
  & {{\bf FreeCat} \href{https://github.com/morganthomas/freecat}{https://github.com/morganthomas/freecat}} \\
  ...
  & {{\bf purescript-group} \href{https://github.com/morganthomas/purescript-group}{https://github.com/morganthomas/purescript-group}} \\
  & \parbox{4.5in}{The PureScript library implementing the concept of groups from abstract algebra.} \\ \\
