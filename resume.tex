...
\begin{tabular}{rl}
  ...
  & {\bf Contractor. Spectrum. Sep 2018 -- present.} \\
  & \parbox{4.5in}{M\&E for legacy JavaScript frontend for flagship set top box product, including build system upgrades and memory management overhaul.} \\ \\
