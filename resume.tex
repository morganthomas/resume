...
\begin{tabular}{lr}
  ...
  \begin{minipage}[b]{0.2\textwidth}
    \begin{tabular}{l}
      morgan.a.s.thomas@gmail.com $\bullet$ (734) 355-3870 $\bullet$ Boulder, CO, USA \\
...
\begin{tabular}{rl}
  ...
  & Haskell \spc JavaScript \spc C\# \spc Rust \spc dabbled in many \\
  ...
  & Node.js \spc Vue \spc React \spc Angular \spc ES6+ \spc Webpack \spc Express \spc Swagger \\
  & {\bf Applied math} \\
  ...
  & {\bf Developer, Co-Founder. Kassir. Jun 2018 -- present.} \\
...
%  & \parbox{4.5in}{Trained IT professionals in JavaScript using self-developed courseware.} \\ \\
  ...
  {\bf Haskell R\&D Project} & {{\bf FreeCat} \href{https://github.com/morganthomas/freecat}{https://github.com/morganthomas/freecat}} \\
  ...
  & \parbox{4.5in}{Mathematical research resulted in three publications in top logic journals. \\ Cumulative GPA 4.1. Graduated Spring 2018 (delayed filing papers).} \\ \\
